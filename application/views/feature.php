            ...
            <div class="col-sm-6 col-xl-3">
                <div class="single_feature">
                    <div class="single_feature_part">
                        ...
                        <p>NextGen Academy memiliki layanan dengan harga yang kompetitif bahkan gratis untuk pelatihan atau diskusi online, pengguna dapat mengikuti kapanpun dan dimanapun </p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="single_feature">
                    <div class="single_feature_part single_feature_part_2">
                        ...
                        <p>NextGen Academy dengan fokus pendidikan non formal, pengembang diri dan kewirausahaan akan terus memberikan materi yang inovatif dan kuratif.</p>
                    </div>
                </div>
            </div>
        </div>
