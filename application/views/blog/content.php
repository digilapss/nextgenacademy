               ...
               <div class="single-post">
                  ...
                  <div class="blog_details">
                     ...
                     <ul class="blog-info-link mt-3 mb-4">
                        <li><a href="#"><i class="far fa-user"></i><?= $category_name ?></a></li>
                        <li><a href="#"><i class="far fa-comments"></i> <?= $total_comment ?> Comments</a></li>
                     </ul>
                  ...
                  <div class="comment-list">
                     <div class="single-comment justify-content-between d-flex">
                        <div class="user justify-content-between d-flex">
                           ...
                           <div class="desc">
                              <p class="comment">
                                 <?= $row_comment_blog->message ?>
                              </p>
                              <div class="d-flex justify-content-between">
                                 <div class="d-flex align-items-center">
                                    <h5>
                                       <a href="#"><?= $row_comment_blog->name ?></a>
                                    </h5>
                                    <p class="date"> <?= $row_comment_blog->create_time ?> </p>
                                 </div>
                                 <div class="reply-btn">
