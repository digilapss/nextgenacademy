            ...
            <div class="row align-items-sm-center align-items-lg-stretch">
                <div class="col-md-7 col-lg-7">
                    <div class="learning_img">
                        <img src="<?php echo base_url() ?>img/learning_img.png" alt="">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        ...
                        <div class="special_cource_text">
                            ...
                            <div class="author_info">
                                <div class="author_img">
                                    <img src="<?php echo base_url() ?>asset/img/author/author_2.png" alt="">
                                    <div class="author_info_text">
                                        <p>Conduct by:</p>
                                        <h5><a href="#">James Well</a></h5>
                                    </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        ...
                        <div class="special_cource_text">
                            ...
                            <div class="author_info">
                                <div class="author_img">
                                    <img src="<?php echo base_url() ?>asset/img/author/author_3.png" alt="">
                                    <div class="author_info_text">
                                        <p>Conduct by:</p>
                                        <h5><a href="#">James Well</a></h5>
                                    </div>
        ...
        <div class="container">
            <div class="row align-items-sm-center align-items-xl-stretch">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="learning_img">
                        <img src="<?php echo base_url() ?>asset/img/advance_feature_img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="textimonial_iner owl-carousel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="<?php echo base_url() ?>asset/img/testimonial_img_1.png" alt="#">
                                    </div>
                                </div>
                        ...
                        <div class="testimonial_slider">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="<?php echo base_url() ?>asset/img/testimonial_img_2.png" alt="#">
                                    </div>
                                </div>
                                <div class="col-xl-4 d-none d-xl-block">
                                    <div class="testimonial_slider_text">
                        ...
                        <div class="testimonial_slider">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="<?php echo base_url() ?>asset/img/testimonial_img_3.png" alt="#">
                                    </div>
                                </div>
                                <div class="col-xl-4 d-none d-xl-block">
                                    <div class="testimonial_slider_text">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="<?php echo base_url() ?>asset/img/blog/blog_1.png" class="card-img-top" alt="blog">
                            <div class="card-body">
                                <a href="#" class="btn_4">Design</a>
                                <a href="blog.html">
                                    <h5 class="card-title">Dry beginning sea over tree limit on the airplane</h5>
                                </a>
                                <p>Which whose darkness saying were life unto fish wherein all fish of together called. You will save the world before avengers is come to here!!!!!!!!!!! Came on guys, wakup to push your limi!!!!</p>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="<?php echo base_url() ?>asset/img/blog/blog_2.png" class="card-img-top" alt="blog">
                            <div class="card-body">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="<?php echo base_url() ?>asset/img/blog/blog_3.png" class="card-img-top" alt="blog">
                            <div class="card-body">
                                <a href="#" class="btn_4">Design</a>
                                <a href="blog.html">
                ...
                <div class="col-sm-6 col-md-4 col-xl-4">
                    <div class="single-footer-widget footer_2">
                        ...
                        <div class="social_icon">
                            <a href="https://www.instagram.com/madiun.nextgen/" target="_blank"> <i class="ti-facebook"></i> </a>
                            <a href="https://www.instagram.com/madiun.nextgen/" target="_blank"> <i class="ti-instagram"></i> </a>
                            <a href="https://www.instagram.com/madiun.nextgen/" target="_blank"> <i class="ti-linkedin"></i> </a>
                        </div>
                    </div>
                </div>
